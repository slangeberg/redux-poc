...
const mapStateToProps = state => {
    const results = state && state.toJS ? state.toJS() : {};
    console.log('AddTravel.mapStateToProps() - results: ', results);
    return results;
}
